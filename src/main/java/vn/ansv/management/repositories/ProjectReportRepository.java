...
public interface ProjectReportRepository extends JpaRepository<ProjectDetailDto, Integer> {
    @Query(value = "SELECT pr.id, pr.uid, p.project_name, c.customer_name, pr.project_type_id, "
            ...
            + "pr.am_manager_id, NULL AS am_manager_name, pr.am_id, NULL AS am_name, pr.pm_manager_id, "
            + "NULL AS pm_manager_name, pr.pm_id, NULL AS pm_name, pr.week, pr.year, pr.ma_hop_dong, "
            + "pr.ma_ke_toan, pr.job_name, pr.description, pr.tong_muc_dau_tu_du_kien, pr.hinh_thuc_dau_tu, "
            + "pr.muc_do_kha_thi, pr.phan_tich_SWOOT, pr.pham_vi_cung_cap, pr.tong_gia_tri_thuc_te, "
            + "pr.so_tien_tam_ung, pr.ke_hoach_tam_ung, pr.so_tien_DAC, pr.hop_dong_DAC, pr.muc_tieu_DAC, "
            + "pr.thuc_te_DAC, pr.so_tien_PAC, pr.hop_dong_PAC, pr.muc_tieu_PAC, pr.thuc_te_PAC, "
            + "pr.so_tien_FAC, pr.hop_dong_FAC, pr.muc_tieu_FAC, pr.thuc_te_FAC, pr.general_issue, "
            + "pr.solution, pr.ke_hoach_tuan_nay, pr.ke_hoach_tuan_sau, pr.ket_qua_tuan_truoc, "
            + "pr.ket_qua_tuan_nay, pr.enabled, pr.ghi_chu, pr.created_by, pr.created_at "
